...
const professionalReadings = [
  {
    ...
    reference: "Brookfield, S. D. (2015). The Skillful Teacher: On Technique, Trust, and Responsiveness in the Classroom. Jossey-Bass.",
  ...
  },
  {
    ...
    color: "green",
    reference: "Marzano, R. J., et al. (2001). Classroom Instruction That Works: Research-Based Strategies for Increasing Student Achievement. ASCD.",
    icon: <FaLightbulb />
  }
];
              ...
              {activeTab === 'summary' ? (
                <div className="prose max-w-none">
                  <div className="flex">
                    ...
                    <br></br>
                    <p className="text-gray-700 leading-relaxed">
                      Reference: {professionalReadings[activeReading].reference}
                    </p>
                      </div>
